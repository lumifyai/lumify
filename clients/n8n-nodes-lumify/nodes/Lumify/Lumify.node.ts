...
export class Lumify implements INodeType {
  description: INodeTypeDescription = {
    displayName: "Lumify",
    name: "lumify",
    icon: { light: "file:lumify.svg", dark: "file:lumify-dark.svg" },
    group: ["transform"],
    version: 1,
    ...
    properties: [
        ...
        options: [
          {
            ...
            default: false,
            description:
              "Whether to inline current odds, scoped by Bookmaker (default: pinnacle). Costs +1 credit for a single book, +2 for bookmaker=all or a comma-separated list.",
          },
          {
          ...
          },
          {
            ...
            description:
              "Bookmaker for inlined odds and intelligence market prices. E.g. pinnacle, fanduel, draftkings, betmgm, caesars, bet365, circa, hardrock, betonline, or all",
          },
        ],
      },
        ...
        options: [
          {
            ...
            default: false,
            description:
              "Whether to inline current odds on each event, scoped by Bookmaker (default: pinnacle). +1 credit per event for a single book, +2 for bookmaker=all or a comma-separated list, when available.",
          },
          {
            displayName: "Include Bet Intelligence",
            name: "include_intelligence",
          ...
          },
          {
            ...
            placeholder: "pinnacle",
            description:
              "Bookmaker for inlined odds and intelligence market prices when either Include option is on. E.g. pinnacle, fanduel, draftkings, betmgm, caesars, bet365, circa, hardrock, betonline, or all",
          },
        ],
      },
      ...
      // ----------------------------------
      {
        ...
        placeholder: "pinnacle",
        description:
          'Bookmaker filter. Default: pinnacle. Use "all" or a comma-separated list (e.g. fanduel,betmgm) for multiple books. Supported: pinnacle, fanduel, draftkings, betmgm, caesars, bet365, circa, hardrock, betonline',
      },
      {
        displayName: "Limit",
