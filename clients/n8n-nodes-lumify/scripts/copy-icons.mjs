...
const pairs = [
  ...
  [
    join(root, "nodes/Lumify/lumify-dark.svg"),
    join(root, "dist/nodes/Lumify/lumify-dark.svg"),
  ],
  [
  ...
  [
    join(root, "credentials/lumify-dark.svg"),
    join(root, "dist/credentials/lumify-dark.svg"),
  ],
];
